...
contract LidoYieldProvider is YieldProvider {
    ...
    function _claim() internal onlyDelegateCall returns (uint256 claimed, uint256 expected) {
        ...
        uint256 lastIndex =
            (lastRequestIndex - _lastClaimedIndex) > claimBatchSize ? firstIndex + claimBatchSize - 1 : lastRequestIndex;
        ...
        uint256[] memory hintIds =
            WITHDRAWAL_QUEUE.findCheckpointHints(claimableRequestIds, 1, WITHDRAWAL_QUEUE.getLastCheckpointIndex());
